    ...
    <section id="contact" className="py-12 bg-gray-100">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex justify-center space-x-8">
          ...
          <a href="https://github.com/nicopanozo" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900 transition duration-300">
            <FaGithub size={40} />
            <span className="block mt-2">GitHub</span>
          </a>
          <a href="mailto:nicopanozoc@gmail.com" className="text-gray-700 hover:text-red-600 transition duration-300">
            <FaEnvelope size={40} />
